...
export default function FeedingModalScreen() {
  ...
  const handleSaveSchedule = async () => {
    try {
      ...
      if (!foodType.trim() || !amount.trim()) {
        Alert.alert('Required', 'Please specify both food type and amount');
        return;
      }
  ...
  return (
    <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
      <Text style={styles.title}>Add Feeding Schedule</Text>
      ...
      <View style={styles.inputContainer}>
        <Text style={styles.label}>Portion / Amount</Text>
        <TextInput 
          style={styles.input} 
          placeholder="e.g. 1 Scoop, 1/2 Can" 
          value={amount} 
